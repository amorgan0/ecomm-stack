...
class PackageInfo:
    ...
    def dimensional_weight(self) -> float:
        ...
        # DIM divisor of 139 for FedEx/UPS, 166 for USPS
...
class CarrierClient(ABC):
    ...
    def map_address_to_carrier_format(self, address: AddressInfo) -> Dict[str, Any]:
        """Map internal address format to carrier-specific format.
        
        Override in subclasses for carrier-specific address formats.
        """
        return {
            "name": address.name,
